...
public class Endpoints {
    ...
    public static final Function<String, String> BUILD_CONFIG_DEPENDENCIES = id -> BUILD_CONFIG + "/" + id + "/dependencies";
    public static final String GROUP_CONFIG = "/group-configs";
    public static final Function<String, String> GROUP_CONFIG_BUILD_CONFIGS = id -> GROUP_CONFIG + "/" + id + "/build-configs";
    public static final String PRODUCT_VERSION = "/product-versions";
    public static final Function<String, String> PRODUCT_VERSION_MILESTONES = id -> PRODUCT_VERSION + "/" + id + "/milestones";
}
