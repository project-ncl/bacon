...
public class OidcClientImpl implements OidcClient {
    ...
    public OidcCredential getCredential(String authServerUrl, String client)
        ...
        OpenIdDeviceFlowResponse deviceFlowResponse = getResponseWithRetries(initialRequest, OpenIdDeviceFlowResponse.class);
        ...
        while (true) {
            ...
            if (response.getStatus() == 200) {
                ...
                return OidcCredential.builder()
                    ...
                    .refreshTokenExpiresIn(Instant.now().plus(oidcResponse.getRefreshExpiresIn(), ChronoUnit.SECONDS))
                    .build();
            } else if (Instant.now().getEpochSecond() - firstRequest.getEpochSecond() > deviceFlowResponse.getExpiresInSeconds()) {
    ...
    public static void main(String[] args) throws Exception {
        OidcClient oidcClient = new OidcClientImpl();
        oidcClient.getCredential("https://auth.stage.redhat.com/auth/realms/EmployeeIDP", "pncdirect");
    }
}
